...
class orangepi_client:
    ...
    def thread_function_1(self):
        ...
        self.ROBOT_instance = robot.ROBOT("qwen2.5_14b_q8", host=MQTT_server, mode="audio")
...
sovits_server = 'http://192.168.31.3:9880'
UI_server = 'http://192.168.31.3:80'
MQTT_server = "192.168.31.3"
